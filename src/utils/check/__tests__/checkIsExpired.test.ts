...
describe('Given checkIsExpired', () => {
  it('return false if the date is not expired', () => {
  ...
  it('return true if the date is expired', () => {
  ...
  it('return true at the boundary value with the expectation of a 10-minute margin', () => {
